...
export function FollowingList({ items, loading, hasMore, search, onSearchChange, onLoadMore }: FollowingListProps) {
  return (
    <div className="space-y-4">
      <div className="relative">
        ...
        <input
          ...
          placeholder="Takip edilenleri ara (isim veya kullanıcı adı)"
      ...
      {loading ? (
        ...
        <p className="text-sm text-neutral-500">Henüz kimseyi takip etmiyor.</p>
      ) : (
        <div className="space-y-2">
          {items.map((item) => (
