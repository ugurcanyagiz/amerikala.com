    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 pb-20 md:pb-6">
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-neutral-500">Topluluktaki son paylaşımlar</p>
        </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    className="w-full min-h-[100px] p-3 rounded-xl bg-neutral-100 dark:bg-neutral-800 border-0 text-neutral-900 dark:text-white placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-red-500 resize-none"
                    maxLength={1000}
                  />
        ...
        {loading ? (
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-neutral-500">İlk gönderiyi sen paylaş!</p>
            </CardContent>
          </Card>
        ) : (
    ...
    <Card className="overflow-hidden">
      <CardContent className="p-0">
        <div className="flex items-start justify-between p-4 pb-0">
          <div className="flex items-center gap-3">
            <Avatar src={post.profiles?.avatar_url || undefined} fallback={authorName} size="md" />
            <div>
        ...
        <div className="flex items-center gap-1 px-4 py-2 border-t border-neutral-100 dark:border-neutral-800">
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors ${
              isLiked ? "text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20" : "text-neutral-500 hover:bg-neutral-100 dark:hover:bg-neutral-800"
            }`}
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-neutral-500 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
          >
          ...
          <button className="flex items-center gap-2 px-3 py-2 rounded-lg text-neutral-500 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors">
            <Share2 size={18} />
          </button>

          <button className="flex items-center gap-2 px-3 py-2 rounded-lg text-neutral-500 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors ml-auto">
            <Bookmark size={18} />
          </button>
        </div>

        {showComments && (
          <div className="border-t border-neutral-100 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50">
            {post.comments && post.comments.length > 0 && (
              <div className="p-4 space-y-3">
                {post.comments.map((comment) => (
                  <div key={comment.id} className="flex gap-3">
                    <Avatar src={comment.profiles?.avatar_url || undefined} fallback={comment.profiles?.username || "U"} size="sm" />
                    <div className="flex-1 bg-white dark:bg-neutral-800 rounded-xl px-3 py-2">
            ...
            {currentUserId && (
              <div className="p-4 pt-0 flex gap-3">
                <Avatar src={currentUserProfile?.avatar_url || undefined} fallback={currentUserProfile?.username || "U"} size="sm" />
                <div className="flex-1 flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 rounded-full bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-sm focus:outline-none focus:ring-2 focus:ring-red-500"
                    onKeyDown={(e) => {
