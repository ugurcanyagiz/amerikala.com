...
export function Sheet({ isOpen, onClose, title, rightAction, footer, children }: SheetProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 md:hidden" role="dialog" aria-modal="true" aria-label={title}>
      ...
      <div className="absolute inset-x-0 bottom-0 flex max-h-[92vh] animate-[sheet-up_220ms_cubic-bezier(0.16,1,0.3,1)] flex-col overflow-hidden rounded-t-[28px] border border-[var(--color-border)] bg-white shadow-[0_-24px_60px_rgba(0,0,0,0.24)]">
        <div className="sticky top-0 z-10 border-b border-[var(--color-border)] bg-white px-4 py-3">
