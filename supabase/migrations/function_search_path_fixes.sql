...
--
-- Decision rules:
-- - IF function is SECURITY DEFINER THEN patch first (highest risk for object shadowing).
-- - IF function lacks explicit search_path THEN set search_path = public, pg_catalog without body changes.
...
-- $function$;
--
-- Existing SECURITY DEFINER ALTER rollback (remove function-level setting):
-- ALTER FUNCTION public.change_user_role(uuid, public.user_role) RESET search_path;
-- ALTER FUNCTION public.handle_new_user() RESET search_path;
-- ALTER FUNCTION public.increment_listing_view_count(uuid) RESET search_path;
-- ALTER FUNCTION public.increment_view_count(text, uuid) RESET search_path;
-- ALTER FUNCTION public.update_event_attendee_count() RESET search_path;
-- ALTER FUNCTION public.update_group_member_count() RESET search_path;
