...
-- - 2.2 review showed broad policy coverage and mostly indexed predicates; FK-leading gaps remained.
--
-- Decision rules:
-- - IF table size/write traffic is modest and migration transaction is acceptable THEN use non-concurrent CREATE INDEX below.
-- - IF table is large/high-write OR lock sensitivity is high THEN run the CONCURRENTLY variants manually outside transaction.
